...
<%
	...
	if(storeTitle==""|| storeEvaluation==""){
		...
		int result = evaluationDao.modify(new EvaluationDTO(postNum,storeTitle, storeEvaluation, purpose, taste, mood, kind, facility, totalScore));
		if(result == -1){
			PrintWriter script = response.getWriter();
			script.println("<script>");
